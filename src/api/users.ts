...
import { saveExpDate, saveToken } from '../components/authorization/saveToStorage';
...
export const createUser = async (user: User): Promise<ResponseUser | undefined> => {
...
export const updateUser = async (id: string, user: Pick<User,'email' | 'password'>): Promise<void> => {
  try {
